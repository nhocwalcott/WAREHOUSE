                                        ...
                                        <div id="acct-password-row" class="span13">
                                            <fieldset>
                                                ...
                                                <div class="control-group ">
                                                    ...
                                                    <input type="text" name="price" id="price" class="price span 2">
                                                </div>
                                                <div class="control-group ">
                                                    <label>Giá bán DK</label>
                                                    <input type="text" name="size" id="size" class="size span 2">
                                                </div>
                                                <div class="control-group">
            ...
            $(document).ready(function() {
                $(".add1").click(function() {
                    ...
                    $.ajax({
                        ...
                        type:'GET',
                        cache:false,
                        data:{"_token":token,"id":id,"qty":qty,"size":size,"price":price},
