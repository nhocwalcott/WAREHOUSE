...
Route::group(['prefix' => 'chucnang'], function() {
    ...
    Route::group(['prefix' => 'xuatkho'], function() {
        ...
        Route::get('vattu/ajax-call', function(){
            ...
            ->join('donvitinh','donvitinh.id','=','vattu.dvt_id')
                ->select('vattu.vt_ten','donvitinh.dvt_ten','kho.kho_ten','vattu.vt_giaban','vattu.vt_giagoc','vattukho.vt_id','vattu.vt_gia','kho.id')
            ->get();

            return Response::json($country);
        });

        Route::get('xuathang/{id}/{qty}/{giaban}', ['as' => 'chucnang.xuatkho.postXuathang','uses' => 'XuatkhoController@postXuathang']);
    ...
    Route::get('kiemke', ['as' => 'chucnang.khohang.getKiemKe','uses' => 'BaocaoController@getKiemKe']);
    Route::get('lichsu', ['as' => 'chucnang.khohang.getLichSu','uses' => 'BaocaoController@getLichSu']);
    Route::post('postSearch', ['as' => 'chucnang.khohang.postSearch','uses' => 'BaocaoController@postSearch']);
    Route::post('postSearch2', ['as' => 'chucnang.khohang.postSearch2','uses' => 'BaocaoController@postSearch2']);
